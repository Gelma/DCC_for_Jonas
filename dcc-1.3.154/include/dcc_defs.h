 ...
 *
 * Rhyolite Software DCC 1.3.154-1.339 $Revision$
 */
...
#define LLPAT	    "l"
#endif
#define	L_HxPAT	    "%#"LLPAT"x"
#define	L_HPAT	    "%"LLPAT"x"
#define	L_HxWPAT(w) "%#"#w LLPAT"x"	/* specified width hex with 0x */
#define	L_HWPAT(w)  "%"#w LLPAT"x"	/* hex without hex without 0x */
#define L_DPAT	    "%"LLPAT"d"
#define L_DWPAT(w)  "%"#w LLPAT"d"	/* decimal with specified width */
...
extern int dcc_strlcpy(char *, const char *, int);
#endif
