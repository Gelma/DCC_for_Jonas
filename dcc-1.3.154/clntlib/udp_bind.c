 ...
 *
 * Rhyolite Software DCC 1.3.154-1.14 $Revision$
 */
...
#ifdef DCC_WIN32
	on = 1;
	if (SOCKET_ERROR == ioctlsocket(*sp, FIONBIO, &on)) {
...
#else
	if (0 > fcntl(*sp, F_SETFD, FD_CLOEXEC)) {
