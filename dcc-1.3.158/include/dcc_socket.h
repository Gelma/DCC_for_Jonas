 ...
 *
 * Rhyolite Software DCC 1.3.158-1.32 $Revision$
 */
...
#define DCC_IN6_ADDR_V4MAPPED(ap) ((ap)->s6_addr32[2] == ntohl(0x0000ffff) \
				   && (ap)->s6_addr32[0] == 0		\
				   && (ap)->s6_addr32[1] == 0)
...
extern u_char udp_create(DCC_EMSG, DCC_SOCKET *, const DCC_SOCKU *, int *);
